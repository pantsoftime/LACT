...
impl ClockDomain {
    fn matches(self, clock_type: ClockspeedType) -> bool {
        let domain = match clock_type {
            ...
            // NVIDIA RM ClockClient types are edited on the Advanced page;
            // they are never rows in either clock frame.
...
fn clock_unit(clock_type: ClockspeedType) -> String {
    match clock_type {
        ...
        // This fork's RM controls live on the Advanced page; units for completeness.
        ClockspeedType::XbarClockOffset
        | ClockspeedType::SysClockOffset
        | ClockspeedType::VideoClockOffset => fl!(I18N, "mhz"),
        ClockspeedType::MsvddOffset
        | ClockspeedType::NvvddOffset
        | ClockspeedType::SysVoltageOffset
        | ClockspeedType::VideoVoltageOffset
        | ClockspeedType::RailLimitDelta(..) => fl!(I18N, "mv"),
        ClockspeedType::GpcXbarRatioMilli => "‰".into(),
        ClockspeedType::RailCurrentLimit(_) => "A".into(),
        ClockspeedType::ThermalInput(_) => "°C".into(),
        ClockspeedType::Reset => unreachable!(),
    }
}
...
fn get_row_step(clock_type: ClockspeedType) -> f64 {
    match clock_type {
        ...
        | ClockspeedType::SysClockOffset
        | ClockspeedType::VideoClockOffset
        | ClockspeedType::GpcXbarRatioMilli => 5.0,
        ClockspeedType::MinVoltage
        | ClockspeedType::MaxVoltage
        | ClockspeedType::VoltageOffset
        | ClockspeedType::VoltageBoost
